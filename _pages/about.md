...
I am a Computer Science Ph.D. student at the [University of British Columbia](https://www.cs.ubc.ca/){:target="\_blank"} supervised by Prof. [Mathias Lécuyer](http://mathias.lecuyer.me/){:target="\_blank"}. My research lies in trustworthy machine learning, with a particular focus on robustness and differential privacy. More broadly, I am interested in understanding how modern machine learning systems can be made more reliable and secure, with an emphasis on formal guarantees and principled methods. I also interned at [RBC Borealis](https://rbcborealis.com/){:target="\_blank"} and [Amazon](https://www.amazon.science/){:target="\_blank"}, where I worked on diffusion-based time series forecasting and experience-guided graph reasoning agent, respectively.
